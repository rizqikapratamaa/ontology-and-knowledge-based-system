...
start :-
    ...
    write(' 7. bijuu_info(Jinchuuriki, Bijuu, TailNumber).      -> Jinchuuriki & Tails info'), nl,
    ...
    write(' 7. element_weakness(Shinobi, WeakElement). -> element weakness of a shinobi'), nl,
    write(' 8. duo_cover_weakness(S1, S2, ElemS1, ElemS2). -> two shinobi who cover each other`s weaknesses'), nl,
    nl,
